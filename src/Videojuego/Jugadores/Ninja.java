...
public class Ninja extends Jugador implements AccionesJugador {

    public  Ninja(){
        Vida=VIDA_BASE_NINJA;
        Ataque=ATAQUE_NINJA;
        Defensa=4;
        Velocidad=40;
        Estamina=20;
    ...
    public static final double VIDA_BASE=VIDA_BASE_NINJA;
    public static final double DEFENSA_BASE=4;
    public static final double ATAQUE_BASE=ATAQUE_NINJA;
    public static final double VELOCIDAD_BASE=40;
    ...
    public void SuperAtaque(){
        ...
        System.out.println(("¡Has usado la lluvia de Shurikens!"));
    ...
    public void accionEspecial() {
        ...
        Jugadores[0].Velocidad=Jugadores[0].Velocidad*1.75;
        Jugadores[1].Velocidad=Jugadores[1].Velocidad*1.75;

        System.out.println(ColoresConsola.enVerde("Los jugadores han aumentado su velocidad en un 75% por el resto del combate"));
    ...
    public String toString() {
        ...
        if(!Furia){
            return ColoresConsola.AZUL+ " (( NINJA: " +
                    " Vida=" + Vida +
                    " || Ataque=" + Ataque +
                    " || Estamina=" + Estamina +
