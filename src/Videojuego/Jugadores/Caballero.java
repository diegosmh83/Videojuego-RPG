...
public class Caballero extends Jugador implements AccionesJugador {
    ...
    public static final double VIDA_BASE=90;
    public static final double DEFENSA_BASE=8;
    public static final double ATAQUE_BASE=24;
    public static final double VELOCIDAD_BASE=24;
    ...
    public void SuperAtaque(){
        ...
        System.out.println(("¡Has usado la  Lanza del Abismo!"));
        ...
        if(SuperA > 0.85){
            double SuperC = ATAQUE_CABALLERO*5;
            ...
            double Super = ATAQUE_CABALLERO*3;
    ...
    public void accionEspecial() {
        ...
        System.out.println(ColoresConsola.enVerde("Has aumentado la vida de todos los jugadores en "+HP+ " puntos"));
