...
public class Guerrero extends Jugador implements AccionesJugador {
    ...
    public static final double VIDA_BASE=100;
    public static final double DEFENSA_BASE=5;
    ...
    public void SuperAtaque(){
        ...
        if(SuperA > 0.85){
            double SuperC = ATAQUE_GUERRERO*5;
            ...
            double Super = ATAQUE_GUERRERO*3;
    ...
    public void accionEspecial() {
        ...
        Jugadores[0].Furia=true;
        Jugadores[1].Furia=true;

        System.out.println(ColoresConsola.enVerde("Los jugadores han entrado en el estado de Furia "));
