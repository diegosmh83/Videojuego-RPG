...
public class Paladin extends Jugador implements AccionesJugador {

    public Paladin(){
        Vida=VIDA_BASE_PALADIN;
        Ataque=ATAQUE_PALADIN;
        Defensa=12;
        Velocidad=25;
        Estamina=25;
        nombre="Paladin";
    ...
    public static final double VIDA_BASE=VIDA_BASE_PALADIN;
    public static final double DEFENSA_BASE=12;
    public static final double ATAQUE_BASE=ATAQUE_PALADIN;
    public static final double VELOCIDAD_BASE=25;
    ...
    public void SuperAtaque(){
        ...
        System.out.println(("¡Has usado el Corte Celestial!"));
        ...
        if(SuperA > 0.85){
            double SuperC = ATAQUE_PALADIN*5;
    ...
    public void danoColateral(){
        ...
        if(!enemigo0muerto && !enemigo1muerto){
            ...
            if(enemigo1muerto){
                apuntar=0;
                System.out.println(ColoresConsola.enVerde("Vas a por el enemigo 1 "+enemigoActual[apuntar].nombre));


            }else{
                apuntar=1;

                System.out.println(ColoresConsola.enVerde("Vas a por el enemigo 2 "+enemigoActual[apuntar].nombre));
    ...
    public void esquivar(){
        ...
        System.out.println(ColoresConsola.enAzul("Has decidido esquivar al enemigo"));
    ...
    public void accionEspecial() {
        ...
        Jugadores[0].Estamina+=aumento;
        Jugadores[1].Estamina+=aumento;

        Jugadores[0].Vida+=aumento;
        Jugadores[1].Vida+=aumento;

        Jugadores[0].Ataque=Jugadores[0].Ataque*1.25;
        Jugadores[1].Ataque=Jugadores[1].Ataque*1.25;

        Jugadores[0].Defensa=Jugadores[0].Defensa*1.25;
        Jugadores[1].Defensa=Jugadores[1].Defensa*1.25;

        Jugadores[0].Velocidad=Jugadores[0].Velocidad*1.25;
        Jugadores[1].Velocidad=Jugadores[1].Velocidad*1.25;

        System.out.println(ColoresConsola.enVerde("Los jugadores han mejorado todos sus atributos hasta el final del combate"));
    ...
    public String toString() {
        ...
        if(Furia){
            return ColoresConsola.AZUL+ " (( PALADIN : " +
                    " Vida=" + Vida +
                    " || Ataque=" + Ataque +
                    " || Estamina=" + Estamina +
