...
public class Escudero extends Jugador implements AccionesJugador {

    public Escudero(){
        Ataque=ATAQUE_ESCUDERO;
        Vida=VIDA_BASE_ESCUDERO;
        Defensa=20;
        Velocidad=20;
        Estamina=20;
        nombre="Escudero";
    ...
    public static final double VIDA_BASE=VIDA_BASE_ESCUDERO;
    public static final double DEFENSA_BASE=20;
    public static final double ATAQUE_BASE=ATAQUE_ESCUDERO;
    ...
    public void SuperAtaque(){
        ...
        System.out.println(("¡Has usado el Filo Infernal!"));
        ...
        if(SuperA > 0.85){
            double SuperC = ATAQUE_ESCUDERO*5;
            ...
            double Super = ATAQUE_ESCUDERO*3;
    ...
    public void accionEspecial() {
        ...
        System.out.println(ColoresConsola.enVerde("Has plantado un muro de 50 puntos de vida que defiende a los jugadores"));
    ...
    public String toString() {
        ...
        if(Furia){
            return ColoresConsola.AZUL+ " (( ESCUDERO : " +
                    " Vida=" + Vida +
                    " || Ataque=" + Ataque +
                    " || Estamina=" + Estamina +
