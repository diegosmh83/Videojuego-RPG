...
public class Valkyria extends Jugador implements AccionesJugador {
    ...
    public static final double VIDA_BASE=VIDA_BASE_VALKYRIA;
    public static final double DEFENSA_BASE=6;
    public static final double ATAQUE_BASE=ATAQUE_VALKYRIA;
    public static final double VELOCIDAD_BASE=28;
    ...
    public void accionEspecial() {
        ...
        Jugadores[0].Ataque=Jugadores[0].Ataque*1.75;
        Jugadores[1].Ataque=Jugadores[1].Ataque*1.75;

        System.out.println(ColoresConsola.enVerde("Los jugadores han aumentado su ataque en un 75% hasta el final del combate "));
    ...
    public String toString() {
        ...
        if(!Furia){
            return ColoresConsola.AZUL+ " (( VALKYRIA: " +
                    " Vida=" + Vida +
                    " || Ataque=" + Ataque +
                    " || Estamina=" + Estamina +
