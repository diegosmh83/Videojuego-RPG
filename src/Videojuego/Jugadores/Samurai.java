...
public class Samurai extends Jugador implements AccionesJugador {

    public Samurai(){
        Vida=VIDA_BASE_SAMURAI;
        Ataque=ATAQUE_SAMURAI;
        Defensa=12;
        Velocidad=21;
        Estamina=10;
        nombre="Samurai";
    ...
    public static final double VIDA_BASE=VIDA_BASE_SAMURAI;
    public static final double DEFENSA_BASE=12;
    public static final double ATAQUE_BASE=ATAQUE_SAMURAI;
    public static final double VELOCIDAD_BASE=21;
    ...
    public void SuperAtaque(){
        ...
        System.out.println(("¡Has usado el Vortice Silencioso!"));
        ...
        if(SuperA > 0.85){
            double SuperC = ATAQUE_SAMURAI*5;
    ...
    public void accionEspecial() {
        ...
        System.out.println(ColoresConsola.enVerde("Los jugadores han aumentado la estamina en "+aumento+" puntos"));
    ...
    public String toString() {
        ...
        if(!Furia){
            return ColoresConsola.AZUL+ " (( SAMURAI: " +
                    " Vida=" + Vida +
                    " || Ataque=" + Ataque +
                    " || Estamina=" + Estamina +
