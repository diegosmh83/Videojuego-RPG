...
public class Araña extends Enemigo implements AccionesBasicas {
    ...
    public void Atacar(){
        ...
        if(defenderse){
            ...
            switch (dificultad){
                ...
                case 1:{
                    if(probabilidad > 0.7){
                        System.out.println(("La araña perdio el turno de ataque por tardar en reincorporarte tras la " +
                                "defensa \n "));
                        defenderse=false;
                        return;
                    }
        ...
        System.out.println(("La araña va a atacar \n "));
    ...
    public void aplicarNerffeo(){
        ...
        Defensa=DEFENSA_ARAÑA_BASE*0.8;
    ...
    public String toString() {
        return ColoresConsola.ROJO+ "(( ARAÑA: Vida:" + Vida+" || Ataque:"+Ataque+" || Defensa: "+Defensa+" || Daño total: "+danoIngfligido+")) "+ColoresConsola.RESET;
    }
}
