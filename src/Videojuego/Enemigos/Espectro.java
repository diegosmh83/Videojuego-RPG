...
public class Espectro extends Enemigo implements AccionesBasicas {
    ...
    public void Atacar(){
        ...
        if(defenderse){
            ...
            switch (dificultad){
                ...
                case 1:{
                    if(probabilidad > 0.7){
                        System.out.println(("El Espectro perdio el turno de ataque por tardar en reincorporarte tras la " +
                                "defensa \n "));
                        defenderse=false;
                        return;
                    }
        ...
        System.out.println(("El Espectro va a atacar "));
    ...
    public void aplicarNerffeo(){
        ...
        Defensa=DEFENSA_ESPECTRO_BASE*0.8;
    ...
    public String toString() {
        return ColoresConsola.ROJO+ "(( ESPECTRO: Vida:" + Vida+" || Ataque:"+Ataque+" || Defensa: "+Defensa+" || Daño total: "+danoIngfligido+")) "+ColoresConsola.RESET;
    }
}
